...
A couple of years later, KLEE was developed\cite{8KLEE} by Cristian Cadar et al. KLEE is a generation based white box fuzzing tool
...
The oracle problem as described in 

explains the issue of telling if a PUT's output was correct or not given the input or as said in "The Oracle Problem in Software Testing: A Survey"\cite{10barr2014oracleProblem} 
\begin{quote}
