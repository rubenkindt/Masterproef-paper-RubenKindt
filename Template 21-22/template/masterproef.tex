...
\include{intro}
\include{chap-1} % CP, SAT and SMT 
\include{chap-2} % Fuzzing
\include{chap-3} % Detecting crucial parts in inputs
\include{chap-4} % Research questions
\include{chap-5} % Implementation
\include{chap-v} % results
\include{chap-x} % conclustion
% ... en zo verder tot
%\include{chap-n}
%\include{conclusion}
