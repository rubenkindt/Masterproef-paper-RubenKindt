...
%	generation based, mutation based | White grey, back box | directed fuzzing, coverage-based fuzzing \ref{11Fuzzingasurvey}
%
%
...
%
%	%dedublication techniques: stack backtrace (hashing), coverage beased, semantics aware \ref{13manes2019survey}
