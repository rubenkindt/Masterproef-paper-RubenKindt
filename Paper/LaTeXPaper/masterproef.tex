...
\begin{preface}
  Thanks all \todo{replace template by real one}
\end{preface}
...
State of the art 
'in deze dissertatie stellen wij een vergelijkende studie voor om auto bugs te vinden in cpl met als voorbeeld taal de CPMpy written by Tia's Guns at al.
...
\include{chap-5} % Research questions
\include{chap-6} % Implementation
\include{chap-7} % results
\include{chap-8} % conclustion
