...
%Alphabetic pls
    ...
    NNF & Negation Normal Form, which is a boolean formula written using only  conjunctions, disjunctions and negations. With negations only occuring in literals. \\
