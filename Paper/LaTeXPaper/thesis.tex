...
\setup{% Verwijder de "%" op de volgende lijn bij UTF-8 karakterencodering
	inputenc=utf8,
	title={Wrong file! Try the masterproef.pdf}, 
	author={ing. Ruben Kindt},
	promotor={Prof.\, dr.\ Tias Guns},
	assessor={Dr. ir. S. Kolb \and Prof. dr. ir. G. Janssens},
...
\usepackage[final]{pdfpages} % poster as appendix
\usepackage{float}
...
\include{chap-7} % conclustion and futher work
%\include{chap-x} % 
...
%\nocite{FuzzingConstraintProgrammingLanguages}
